                ...
                if error != nil {
                    ...
                    imageReference.downloadURL { (url, error) in
                        if error == nil {
                            ...
                            let firestorePost = ["imageUrl" : imageUrl!, "postedBy" : Auth.auth().currentUser!.email!, "postComment" : self.textFieldComment.text!,"date" : FieldValue.serverTimestamp(), "likes" : 0 ] as [String : Any]
                            ...
                            firestoreReference = firestoreDatabase.collection("Posts").addDocument(data: firestorePost, completion: { (error) in
                                if error != nil {
                                    ...
                                    self.imageViewSelected.image = UIImage(named: "camera.png")
